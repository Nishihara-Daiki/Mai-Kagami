...
public:
	MyDrawGraph(const char *fileName, const double* sceneOpacity); //初期化
	MyDrawGraph(const float x, const float y, const char *fileName, const double* sceneOpacity, const double ExRate = 1.0); //初期化
	void ContentView(); //表示
	void Load();
...
public:
	MyDrawMovie(const char *filename, const double* sceneOpacity); //初期化
	MyDrawMovie(const float x, const float y, const char *filename, const double* sceneOpacity, const double ExRate); //初期化
	void ContentView(); //表示
