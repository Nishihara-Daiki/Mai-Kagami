...
ModeSelectButton::ModeSelectButton(Font *font, Touch *touch) {
	...
	button[0] = new TriangleButton2(font, touch, "通し練習モード", through, 2, 0, WIDTH * 0.57, &sceneOpacity, "Blue");
	button[1] = new TriangleButton2(font, touch, "部分練習モード", part, 2, 2, WIDTH * 0.57, &sceneOpacity, "Yellow");
	button[2] = new CircleButton2(font, touch, "戻る", 4, &sceneOpacity);
}
