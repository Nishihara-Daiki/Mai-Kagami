...
ThroughFinish::ThroughFinish(Font *font, Touch *touch) {
	...
	button[0] = new CircleButton(font, touch, "おすすめ練習", 0, WIDTH * 0.75, &sceneOpacity, "White");
	button[1] = new CircleButton(font, touch, "もう一度", 1, WIDTH * 0.75, &sceneOpacity, "White");
	button[2] = new CircleButton(font, touch, "部分練習", 2, WIDTH * 0.75, &sceneOpacity, "White");
